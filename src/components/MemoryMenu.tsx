...
export function MemoryMenu({ settings, setSettings, onClose, vibrate, showToast }: any) {
  ...
  return (
    <div className="fixed inset-0 bg-[var(--bg-main)] z-[150] flex flex-col pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] animate-in fade-in duration-200">
